...
namespace Tests\Wayfair\Tremor;
...
final class ClientTest extends TestCase
{
    public function testCanBeCreatedWithAnURL(): void
    {
        $this->assertInstanceOf(
            Client::class,
            new Client(new \GuzzleHttp\Client(['base_url' => 'http://127.0.0.1']))
        );
    }
    ...
    public function testCanBeCreatedWithAnURLAndJSONBodyEncoding(): void
    {
        $this->assertInstanceOf(
            Client::class,
            new Client(new \GuzzleHttp\Client(['base_url' => 'http://127.0.0.1']), ['body_encoding' => 'json'])
        );
    }
    ...
    public function testCanBeCreatedWithAnURLAndMsgPackBodyEncoding(): void
    {
        $this->assertInstanceOf(
            Client::class,
            new Client(new \GuzzleHttp\Client(['base_url' => 'http://127.0.0.1']), ['body_encoding' => 'msgpack'])
        );
    }
    ...
    public function testFailsWithBadBodyEncoding(): void
    {
        ...
        new Client(new \GuzzleHttp\Client(['base_url' => 'http://127.0.0.1']), ['body_encoding' => 'blargh']);
    ...
    public function testCanBeCreatedWithAnURLAndJSONEventEncoding(): void
    {
        $this->assertInstanceOf(
            Client::class,
            new Client(new \GuzzleHttp\Client(['base_url' => 'http://127.0.0.1']), ['event_encoding' => 'json'])
        );
    }
    ...
    public function testCanBeCreatedWithAnURLAndMsgPackEventEncoding(): void
    {
        $this->assertInstanceOf(
            Client::class,
            new Client(new \GuzzleHttp\Client(['base_url' => 'http://127.0.0.1']), ['event_encoding' => 'protobuf'])
        );
    }
    ...
    {
        $this->expectException(Exceptions\ClientException::class);
        new Client(new \GuzzleHttp\Client(['base_url' => 'http://127.0.0.1']), ['event_encoding' => 'blargh']);
