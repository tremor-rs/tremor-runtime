...
pub type LogStore = Adaptor<TremorRaftConfig, store::Store>;
pub type StateMachineStore = Adaptor<TremorRaftConfig, store::Store>;

pub type TremorRaftImpl = Raft<TremorRaftConfig, Network, LogStore, StateMachineStore>;
