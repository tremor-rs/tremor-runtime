...
impl Sink for GCSWriterSink {
    ...
    async fn connect(&mut self, ctx: &SinkContext, _attempt: &Attempt) -> Result<bool> {
        ...
        connectors::spawn_task(ctx.clone(), http_task(rx, self.done_until.clone()));
        dbg!("Spawned connector task!");
