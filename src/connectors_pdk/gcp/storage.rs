...
use crate::connectors::gcp::auth::GcsClient;
...
pub(crate) async fn list_buckets(client: &GcsClient, project_id: &str) -> Result<Value<'static>> {
    let url = format!(
...
pub(crate) async fn list_objects(client: &GcsClient, bucket_name: &str) -> Result<Value<'static>> {
    let url = format!(
        "{}/b/{}/o",
...
pub(crate) async fn delete_bucket(client: &GcsClient, bucket_name: &str) -> Result<Value<'static>> {
    let url = format!(
